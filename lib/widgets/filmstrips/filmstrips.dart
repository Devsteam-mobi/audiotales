...
import 'package:audiotales/widgets/filmstrips/filmstripDetails.dart';
...
class Filmstrips extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      appBar: new AppBar(
        title: new Text('Диафильмы'),
      ),
      body: Container(
        child: new FutureBuilder<List<TaleInf>>(
          future: filmstripsAPI(),
                    ...
                    return new ListTile(
                        ...
                        onTap: (){
                          var route = new MaterialPageRoute(
                            ...
                            new FilmstripDetails(taleInf: snapshot.data[index]),
                          );
