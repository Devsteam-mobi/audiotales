...
import 'package:audiotales/widgets/music/player/player_widgetMusic.dart';
...
class _MusicPlayerState extends State<MusicPlayer> {
  ...
  Widget localFile() {
    ...
    return _tab([
      Text(widget.musicDetailsJSON.name,
        style: new TextStyle(
          fontSize: 30.0,
      ...
      localFilePath == null
          ...
          : MusicPlayerWidget(url: localFilePath, autoPlay: autoPlay, musicDetailsJSON: widget.musicDetailsJSON),
    ]);
  }
